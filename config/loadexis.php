...
<script src="assets/js/loadexis.js" defer></script>
               ...
               <div class="page-title">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                         <div class="x_panel">
                              ...
                              <form id='evidence' name='evidence' enctype="multipart/form-data" autocomplete="off"
                                   action="batchexis.php" method="post">
                                   ...
                                   <div class="form-group">
                                        <div class="col-md-3 col-sm-3 col-xs-12 ">
                                             <button id="addroute" type="submit"
