                        ...
                        <form class="form-horizontal" role="form" id="search_form" onsubmit="event.preventDefault();">
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <input type="text" class="form-control" id="q" placeholder="Nombre, RFC o Código..."
                                        onkeyup="load(1);">
                                </div>
        ...
        <div class="modal-content">
            <form id="cust_form" class="form-horizontal" novalidate>
                ...
                <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h5 style="border-bottom: 1px solid #eee; padding-bottom: 5px; color: #2A3F54;"><i
                                    class="fa fa-file-text"></i> Datos Fiscales</h5>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h5 style="border-bottom: 1px solid #eee; padding-bottom: 5px; color: #2A3F54;"><i
                                    class="fa fa-user"></i> Identificación</h5>
                        </div>
                        ...
                        <div id="div_campos_fisica">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control persona-fisica-input" id="nombre"
                                            name="nombre">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control persona-fisica-input" id="ap_paterno"
                                            name="ap_paterno">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control persona-fisica-input" id="ap_materno"
                                            name="ap_materno">
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h5 style="border-bottom: 1px solid #eee; padding-bottom: 5px; color: #2A3F54;"><i
                                    class="fa fa-envelope"></i> Contacto</h5>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h5 style="border-bottom: 1px solid #eee; padding-bottom: 5px; color: #2A3F54;"><i
                                    class="fa fa-map-marker"></i> Dirección</h5>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
